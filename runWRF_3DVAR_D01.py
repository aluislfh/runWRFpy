...
def main(sdates, edates, gfsdir, init):
    ...
    WRFDADIR    = '/home/adrian/WRF/WRF_4.3/WRFDA'
    DATA_GRB = '/media/adrian/hdd_glm/PHD_runs/GFS/'+gfsdir
    RDIR     = '/media/adrian/hdd_glm/PHD_runs/RUNS_3DVAR/D01'
...
#            os.system(cmd)
    ...
    if DA_OPT == 'activado':
        ...
        if sYYYY+sMM == '201812':
            cmd = 'cp -vf /media/adrian/hdd_glm/PHD_runs/GenBE/matrix1_d01 '+ RUN_DIR + '/be.dat'
        elif sYYYY+sMM == '201910':
            cmd = 'cp -vf /media/adrian/hdd_glm/PHD_runs/GenBE/matrix2_d01 '+ RUN_DIR + '/be.dat'
        else:
            cmd = 'cp -vf /media/adrian/hdd_glm/PHD_runs/GenBE/matrix3_d01 '+ RUN_DIR + '/be.dat'
        ...
        if sYYYY+sMM == '201812':
            cmd = 'cp -vf /media/adrian/hdd_glm/PHD_runs/GenBE/matrix1_d02 '+ RUN_DIR + '/be.dat'
        elif sYYYY+sMM == '201910':
            cmd = 'cp -vf /media/adrian/hdd_glm/PHD_runs/GenBE/matrix2_d02 '+ RUN_DIR + '/be.dat'
        else:
            cmd = 'cp -vf /media/adrian/hdd_glm/PHD_runs/GenBE/matrix3_d02 '+ RUN_DIR + '/be.dat'
