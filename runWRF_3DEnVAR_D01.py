...
def main(sdates, edates, gfsdir, init):
    ...
    WRFDIR   = '/home/adrian/WRF/WRF3.8.1/WRFV3'
    ...
    RDIR     = '/media/adrian/hdd_glm/PHD_runs/RUNS_3DEnVAR/D01'
...
#            os.system(cmd)
    ...
    #write wps namelist    
    f = open(fname_wps,'w')
    s = namelist_wps(sdates, edates, GEOG_dir, RDIR)
    f.write(s)
    f.close()
    ...
    if DA_OPT == 'activado':
        ...
        os.system('ln -sf '+ENS_DIR+'/'+sYYYY+sMM+sDD+sHH+'/'+fdates[0]+'/wrfout_d01_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00 '+RUN_DIR+'/wrfout_d01_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00.e001')
        os.system('ln -sf '+ENS_DIR+'/'+sYYYY+sMM+sDD+sHH+'/'+fdates[1]+'/wrfout_d01_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00 '+RUN_DIR+'/wrfout_d01_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00.e002')
        os.system('ln -sf '+ENS_DIR+'/'+sYYYY+sMM+sDD+sHH+'/'+fdates[2]+'/wrfout_d01_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00 '+RUN_DIR+'/wrfout_d01_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00.e003')
        os.system('ln -sf '+ENS_DIR+'/'+sYYYY+sMM+sDD+sHH+'/'+fdates[3]+'/wrfout_d01_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00 '+RUN_DIR+'/wrfout_d01_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00.e004')

        os.system('cp -vf '+ENS_DIR+'/'+sYYYY+sMM+sDD+sHH+'/'+fdates[3]+'/wrfout_d01_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00 '+RUN_DIR+'/wrfout_d01_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00.mean')
        os.system('cp -vf '+ENS_DIR+'/'+sYYYY+sMM+sDD+sHH+'/'+fdates[3]+'/wrfout_d01_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00 '+RUN_DIR+'/wrfout_d01_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00.vari')
        ...
        cmd = 'cp -vf '+genbe+'/'+bedat+'_d01 '+ RUN_DIR + '/be.dat'
        os.system(cmd)
        ...
        os.system(cmd)
        cmd = 'ln -sf wrfout_d01_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00.mean fg'
        os.system(cmd)
        ...
        # runing wrfvar for domain 2

        os.system('ln -sf '+ENS_DIR+'/'+sYYYY+sMM+sDD+sHH+'/'+fdates[0]+'/wrfout_d02_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00 '+RUN_DIR+'/wrfout_d02_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00.e001')
        os.system('ln -sf '+ENS_DIR+'/'+sYYYY+sMM+sDD+sHH+'/'+fdates[1]+'/wrfout_d02_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00 '+RUN_DIR+'/wrfout_d02_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00.e002')
        os.system('ln -sf '+ENS_DIR+'/'+sYYYY+sMM+sDD+sHH+'/'+fdates[2]+'/wrfout_d02_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00 '+RUN_DIR+'/wrfout_d02_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00.e003')
        os.system('ln -sf '+ENS_DIR+'/'+sYYYY+sMM+sDD+sHH+'/'+fdates[3]+'/wrfout_d02_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00 '+RUN_DIR+'/wrfout_d02_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00.e004')

        os.system('cp -vf '+ENS_DIR+'/'+sYYYY+sMM+sDD+sHH+'/'+fdates[0]+'/wrfout_d02_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00 '+RUN_DIR+'/wrfout_d02_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00.mean')
        os.system('cp -vf '+ENS_DIR+'/'+sYYYY+sMM+sDD+sHH+'/'+fdates[0]+'/wrfout_d02_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00 '+RUN_DIR+'/wrfout_d02_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00.vari')

        f = open('gen_be_ensmean_nl.nl','w')
        s = ensmean_nl(RUN_DIR, 'wrfout_d02_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00')
        f.write(s)
        f.close()
        ...
        os.chdir(RUN_DIR+'/ep')
        os.system('./gen_be_ep2.exe '+sYYYY+sMM+sDD+sHH+' 4 . ../wrfout_d02_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00')
        os.chdir(RUN_DIR)
        ...
        cmd = 'cp -vf '+genbe+'/'+bedat+'_d02 '+ RUN_DIR + '/be.dat'
        os.system(cmd)
        ...
        cmd = 'ln -sf wrfout_d02_'+sYYYY+'-'+sMM+'-'+sDD+'_'+sHH+':00:00.mean fg'
        os.system(cmd)

        #--------
        cmd = './da_wrfvar.exe'
        os.system(cmd)
        cmd = 'mv rsl.out.0000 wfrvar2_rsl.out.0000'
        os.system(cmd)
        cmd = 'mv wrfinput_d02 wrfinput_d02.old' 
        os.system(cmd)
        cmd = 'mv wrfvar_output wrfinput_d02'
        os.system(cmd)
        #--------
...
def namelist_wrf(startTime, endTime):
...
'''.format(YYYY0, MM0, DD0, HH0, YYYY1, MM1, DD1, HH1)
  return s

# WPS
def namelist_wps(startTime, endTime, GEOG_dir, RDIR):
...
&metgrid
 ...
 io_form_metgrid = 2,
/
'''.format(startTime, endTime, GEOG_dir, RDIR)
  return s
