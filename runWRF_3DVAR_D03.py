...
def main(sdates, edates, gfsdir, init):
    ...
    WRFDADIR    = '/home/adrian/WRF/WRF_4.3/WRFDA-CVCLOUD/WRF-4.3'  # '/home/adrian/WRF/WRF_v3.8.1/WRFDA_CV'
    DATA_GRB = '/media/adrian/hdd_glm/PHD_runs/GFS/'+gfsdir
    RDIR     = '/media/adrian/hdd_glm/PHD_runs/RUNS_3DVAR/D03'
    RUN_DIR  = RDIR+'/'+sYYYY+sMM+sDD+sHH

    RUN_DIR1  = '/media/adrian/hdd_glm/PHD_runs/RUNS_3DVAR/D01/'+sYYYY+sMM+sDD+sHH
...
#            os.system(cmd)
    ...
    if DA_OPT == 'activado':
        ...
        if sYYYY+sMM == '201812':
            cmd = 'cp -vf /media/adrian/hdd_glm/PHD_runs/GenBE/matrix1_d03 '+ RUN_DIR + '/be.dat'
        elif sYYYY+sMM == '201910':
            cmd = 'cp -vf /media/adrian/hdd_glm/PHD_runs/GenBE/matrix2_d03 '+ RUN_DIR + '/be.dat'
        else:
            cmd = 'cp -vf /media/adrian/hdd_glm/PHD_runs/GenBE/matrix3_d03 '+ RUN_DIR + '/be.dat'
